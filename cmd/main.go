...
import (
	...
	"github.com/keshon/dice-roller/dicer/discord"
	"github.com/keshon/dice-roller/internal/config"
	"github.com/keshon/dice-roller/internal/db"
	"github.com/keshon/dice-roller/internal/manager"
	"github.com/keshon/dice-roller/internal/rest"
...
func main() {
	...
	if _, err := db.InitDB("./dice-roller.db"); err != nil {
...
func startBotInstances(session *discordgo.Session, guildID string) {
	botInstances[guildID] = &discord.BotInstance{
		DiceRoller: discord.NewDiscord(session, guildID),
	}
	botInstances[guildID].DiceRoller.Start(guildID)
}
