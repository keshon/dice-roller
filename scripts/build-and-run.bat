...
rem Build command
go run -ldflags "-X github.com/keshon/dice-roller/internal/version.BuildDate=%BUILD_DATE% -X github.com/keshon/dice-roller/internal/version.GoVersion=%GO_VERSION%" cmd\diceroller\diceroller.go
