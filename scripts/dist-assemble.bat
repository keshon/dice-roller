...
set TARGET_PLATFORM=diceroller-win
...
set OUTPUT_ARCHIVE=dist\diceroller-win-v%CURRENT_DATE%.zip
...
copy diceroller.exe dist\%TARGET_PLATFORM%
...
%UPX_PATH% --best dist\%TARGET_PLATFORM%\dbt.exe
